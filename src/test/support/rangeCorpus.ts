...
export const rangeCorpus: RangeCorpusEntry[] = [
    ...
    { name: "mixed content beginning with markup", fragment: "<Root><A/> <B/></Root>" },
    { name: "mixed content ending with text", fragment: "<w><r><a/>x</r></w>" },
    { name: "text content over several lines", fragment: "<r><p>line one\nline two</p></r>" },
